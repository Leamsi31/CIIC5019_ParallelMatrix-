...
/**
 * @file transposed_sequential.c
 * @brief Implementation of transposed sequential matrix multiplication.
 */

/**
 * @brief Perform transposed sequential matrix multiplication.
 * 
